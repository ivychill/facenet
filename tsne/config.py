...
mode_arg.add_argument('--num_samples', type=int, default=128,
...
misc_arg.add_argument('--data_dir', type=str, default='../facenet/emb/pairwise/validate/',
                        help='Directory where data is stored')
misc_arg.add_argument('--plot_dir', type=str, default='../facenet/emb/pairwise/validate/',
