...
case $1 in
    ...
    represent)
        ...
        --data_dir /home/asus/fengchen/facenet/data/validate \
        --output_dir /home/asus/fengchen/facenet/emb/validate \
    ...
    train)
        ...
        python src/train_tripletloss_double_assoc.py \
          --logs_base_dir ./logs \
    ...
    train_scratch)
        ...
        export CUDA_VISABLE_DEVICES=1
        echo "train_tripletloss ....."
        python src/train_tripletloss_mmd_scratch.py \
          --logs_base_dir ./logs \
          --models_base_dir ./models/ \
          --data_dir_ID ./data/pairwise/id/ \
          --data_dir_camera ./data/pairwise/camera/ \
    ...
    train_mmd)
        ...
        export CUDA_VISABLE_DEVICES=1
        echo "train_tripletloss ....."
        python src/train_tripletloss_mmd_scratch_1.py \
          --logs_base_dir ./logs \
          --models_base_dir ./models/ \
          --data_dir_ID ./data/pairwise/id/ \
          --data_dir_camera ./data/pairwise/camera/ \
