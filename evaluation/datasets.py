...
def main_txt(args):
    ...
    if(args.mode=='pairs'):
        ...
        for cls in dataset:
            ...
            train = 0
            for i in range(len(cls.image_paths)):
                output_train_dir = os.path.join(output_dir, cls.name)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input_dir', default='/opt/yanhong.jia/datasets/bench_image_align_160', type=str,
                        help='Directory with unaligned images.')
    parser.add_argument('--output_dir', default='/opt/yanhong.jia/datasets/bench_image_align_160_1', type=str,
                        help='Directory with aligned face thumbnails.')
    parser.add_argument('--mode', default='gen_pairs', type=str,
                        help='gen_pairs.')
